...
A minimal Selenium scraper for paginated business-data tables on [Reference USA](https://www.referencesolutions.com/) (the business-records product formerly sold as ReferenceUSA, now part of Data Axle). Most universities license it through their library, behind a proxy and an SSO login — Shibboleth, CAS, Okta, Azure AD, whatever your campus uses.
